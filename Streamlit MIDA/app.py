...
def generate_pdf(df, year: int, period_key: str) -> bytes:
    ...
    mod.sec_nia(story, cur, prev, year, pl)
...
if uploaded_file is None:
    ...
    if generate:
        ...
        sections = [
            ...
            (10, "YoY Summary"),
            (18, "QoQ Summary"),
            (26, "Sector Overview & CIPE"),
            (36, "Employment Breakdown (MTS, Salary)"),
            (47, "Export & Raw Materials"),
            (57, "Industry 4.0 & Indicators"),
            (66, "Green Investment"),
            (75, "State Analysis"),
            (84, "Country Analysis"),
            (91, "Top 10 Projects"),
            (98, "National Investment Aspirations (NIA)"),
        ]
    ...
    if "pdf_bytes" in st.session_state:
        ...
        toc_items = [
            ...
            "8. National Investment Aspirations (NIA)",
            "  8A. Projects & Employment (YoY)",
            "  8B. Investment — Domestic, Foreign, Total (YoY)",
            "  8C. Value Added, MTS, CIPE & Salary >RM5,000",
        ]
        cols = st.columns(2)
